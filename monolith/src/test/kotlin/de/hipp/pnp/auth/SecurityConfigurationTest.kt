...
class SecurityConfigurationTest :
    StringSpec({
        ...
        "JWT Authentication Converter - Goku (孫悟空) gets USER role for new user" {
            ...
            every { userInfoProducer.getCustomerInfoFor("goku123") } returns
                Customer(
                    userId = "1",
                    vorname = "Son",
                    nachname = "Goku",
        ...
        "JWT Authentication Converter - Tony Stark gets ADMIN and USER roles" {
            ...
            every { userInfoProducer.getCustomerInfoFor("tony123") } returns
                Customer(
                    userId = "1",
                    vorname = "Tony",
                    nachname = "Stark",
        ...
        "JWT Authentication Converter - Spider-Man gets USER role only" {
            ...
            every { userInfoProducer.getCustomerInfoFor("peter123") } returns
                Customer(
                    userId = "2",
                    vorname = "Peter",
                    nachname = "Parker",
        ...
        "Customer bean - Batman with valid JWT in security context" {
            ...
            every { userInfoProducer.getCustomerInfoFor("bruce123") } returns
                Customer(
                    userId = "3",
                    vorname = "Bruce",
                    nachname = "Wayne",
        ...
        "Auto-user creation - Naruto (ナルト) is created with USER role" {
            ...
            every { userInfoProducer.getCustomerInfoFor("naruto123") } returns
                Customer(
                    userId = "4",
                    vorname = "",
                    nachname = "",
        ...
        "Role extraction - Pikachu (ピカチュウ) with empty role gets USER" {
            ...
            every { userInfoProducer.getCustomerInfoFor("pikachu123") } returns
                Customer(
                    userId = "5",
                    vorname = "Pikachu",
                    nachname = "",
        ...
        "JWT Authentication - Neo from Matrix gets proper authorities" {
            ...
            every { userInfoProducer.getCustomerInfoFor("neo123") } returns
                Customer(
                    userId = "6",
                    vorname = "Thomas",
                    nachname = "Anderson",
