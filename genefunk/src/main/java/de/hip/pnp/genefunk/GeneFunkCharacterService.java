...
@Service
@Transactional
class GeneFunkCharacterService implements I5ECharacterService<GeneFunkCharacter> {
    ...
    public GeneFunkCharacterService(GeneFunkCharacterRepository repository, GeneFunkGenomeService genomeService, GeneFunkClassService classService) {
