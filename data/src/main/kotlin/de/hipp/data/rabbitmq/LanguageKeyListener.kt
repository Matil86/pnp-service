...
class LanguageKeyListener(
    ...
    @get:RabbitListener(queues = [RoutingKeys.GET_ALL_LANGUAGE_KEYS_ROUTING_KEY])
    val allLanguageKeys: String
        get() {
            val message =
    ...
    fun getAllLanguageKeysByGameType(message: String): String {
